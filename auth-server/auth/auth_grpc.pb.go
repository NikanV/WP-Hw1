...
func (c *req_PQClient) RequestPQ(ctx context.Context, in *PQRequest, opts ...grpc.CallOption) (*PQResponse, error) {
	out := new(PQResponse)
	err := c.cc.Invoke(ctx, "/Req_PQ/RequestPQ", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReq_PQServer) RequestPQ(context.Context, *PQRequest) (*PQResponse, error) {
...
func _Req_PQ_RequestPQ_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PQRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(Req_PQServer).RequestPQ(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Req_PQ/RequestPQ",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Req_PQServer).RequestPQ(ctx, req.(*PQRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Req_PQ_RequestPQ_Handler,
		},
	},
...
func (c *req_DH_ParamsClient) RequestDHparams(ctx context.Context, in *DHRequest, opts ...grpc.CallOption) (*DHResponse, error) {
	out := new(DHResponse)
	err := c.cc.Invoke(ctx, "/Req_DH_Params/RequestDHparams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReq_DH_ParamsServer) RequestDHparams(context.Context, *DHRequest) (*DHResponse, error) {
...
func _Req_DH_Params_RequestDHparams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DHRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(Req_DH_ParamsServer).RequestDHparams(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Req_DH_Params/RequestDHparams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Req_DH_ParamsServer).RequestDHparams(ctx, req.(*DHRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Req_DH_Params_RequestDHparams_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "auth/auth.proto",
